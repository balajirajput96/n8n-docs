...
- A **User Token**: To generate a token, select your **Profile > My preferences > My User Information > Manage my user tokens**. Refer to [Creating and using user tokens](https://help.quickbase.com/docs/create-and-use-user-tokens) for detailed instructions.
